    ...
    <>
      ...
      <div className='flex items-center justify-between mx-auto max-w-[1200px]'>
        ...
        <div className='font-bold'>
          ...
          <button onClick={() => setToggle(false)} className={`py-3 px-4 border-1 border-gray-300 rounded-r-2xl border-l-0 ${toggle === false ? 'bg-[#E7FE29]' : ''}`}>Selected <span>{showSelected.length}/6</span></button>
        </div>
      </div>
